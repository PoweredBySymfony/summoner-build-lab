...
- Status: partially resolved; admin dialogs, shared helper modules, and search filters have been extracted, and `src/pages/Admin.tsx` is now focused on page orchestration.
