  ...
  return (
    <div className="min-h-screen bg-background pb-10 pt-20">
      <div className="container mx-auto max-w-[1700px] space-y-5 px-4">
            ...
            <div className="flex min-w-0 flex-col gap-4 sm:flex-row sm:items-start sm:gap-5">
              {profileIconUrl ? (
                <img
                  ...
                  className="h-24 w-24 rounded-3xl border border-border/60 object-cover"
                />
              ) : (
              ...
              <div className="min-w-0">
                ...
                <h1 className="mt-3 break-words font-heading text-3xl font-bold text-foreground sm:text-4xl">
        ...
        {isLoading ? (
          <section className="glass-surface rounded-[32px] p-8 text-muted-foreground">
          ...
          <>
            <section className="grid gap-4 md:grid-cols-2 xl:grid-cols-6">
              ...
              <div className="glass-surface rounded-3xl p-5">
                ...
                <p className="text-sm text-muted-foreground">Degats moyens</p>
                          ...
                          {match.items.map((item) => (
                            item.icon ? (
                              <img
                                ...
                                alt={item.name}
                                title={item.name}
                                className="h-10 w-10 rounded-lg border border-border/60 bg-secondary object-cover"
                              />
                            ) : (
                              <div
                                key={`${match.matchId}-${item.riotItemId}`}
                                title={item.name}
                                className="flex h-10 w-10 items-center justify-center rounded-lg border border-border/60 bg-secondary text-[10px] font-bold text-foreground"
                              >
